...
def add_messages_handler(lambda_event: LambdaEvent, user: Optional[CognitoUser]) -> Context.FilteredContext:
    """
    ...
    body = AddMessagesInput(**json.loads(lambda_event.body))
    ...
    context.messages.extend(new_dict_messages)
