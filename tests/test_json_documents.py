...
class TestJSONDocuments(unittest.TestCase):
        ...
        request = create_request(
            ...
            body={
                ...
                "data": {
                    ...
                    "People": [
                        {"name": "Alice"},
                        {"name": "Bob", "age": 30, "city": "Wonderland"},
                    ],
                },
            },
        )
    ...
    def test_update_json_document(self):
        ...
        request = create_request(
            ...
            path=f"/json-document/{json_document.document_id}",
            headers={"Authorization": access_token},
            body={"data": {"original_key": "updated_value", "new_key": "new_value"}},
        )
    ...
    def test_get_json_documents(self):
        ...
        doc1 = JSONDocument.create_json_document(
            JSONDocument.CreateJSONDocumentParams(
                org_id=user.organizations[0], name="Document 1", data={}
            )
        )

        doc2 = JSONDocument.create_json_document(
            JSONDocument.CreateJSONDocumentParams(
                org_id=user.organizations[0], name="Document 2", data={}
            )
        )
        ...
        request = create_request(
            ...
            path="/json-documents",
            headers={"Authorization": access_token},
            query_string_parameters={"org_id": user.organizations[0]},
        )
        ...
        json_document = JSONDocument.create_json_document(
            JSONDocument.CreateJSONDocumentParams(
                ...
                data={
                    ...
                    "nested": {"field1": "public_data", "field2": 100},
                },
            )
        )
    ...
    def test_set_get_add_delete_and_shape(self):
        ...
        req = create_request(
            ...
            body={
                "path": "people",
                "value": json.dumps({"name": "Bob", "age": 30}),
                "type": "json",
            },
        )
        res = lambda_handler(req, None)
        ...
        req = create_request(
            ...
            body={
                ...
                "value": json.dumps(
                    [
                        {"name": "Athena", "type_code": 2},
                        {"name": "Failt", "type_code": 2},
                    ]
                ),
                "type": "json",
            },
        ...
        self.assertEqual(
            body["schema"]["pets"], [{"name": "string", "type_code": "number"}]
        )
        ...
        req = create_request(
            ...
            body={
                "path": "pets",
                "value": json.dumps({"name": "Luna", "type_code": 2, "age": 3}),
                "type": "json",
            },
        )
        res = lambda_handler(req, None)
        ...
        self.assertEqual(
            body["schema"]["pets"],
            [{"name": "string", "type_code": "number", "age": "optional number"}],
        )
    ...
    def test_public_document_operations(self):
        ...
        doc = JSONDocument.create_json_document(
            JSONDocument.CreateJSONDocumentParams(
                ...
                name="Public Ops",
                is_public=True,  # Set document as public
                data={"profile": {"first": "john"}, "tags": ["personal"], "items": []},
            )
        )
        ...
        add_obj_request = create_request(
            ...
            body={
                "path": "items",
                "value": json.dumps({"name": "Item 1", "quantity": 5}),
                "type": "json",
            },
        )
